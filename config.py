...
DATA_PATH = _resolve_path(os.getenv("DATA_PATH", str(PROJECT_ROOT / "data" / "raw_data" / "clickbait" / "tencent.csv")))
...
LLM_CACHE_PATH = _resolve_path(os.getenv("LLM_CACHE_PATH", str(MODEL_DIR / "llm_cache_tc_ds.json")))
